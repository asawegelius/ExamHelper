...
public class AnswerCollection extends ExamHelperCollectionDao<Answer, Long>{
	...
	public void populateDatabase(){
		save(new Answer(8, 8, 32, "Regression testing is testing that nothing has regressed. Retesting (or confirmation testing) confirms the fix is correct by running the same test after the fix has been made. No other option has both of these as true."));
		save(new Answer(10, 10, 38, "Sometimes time/money does signify the end of testing, but it is really complete when everything that was set out in advance has been achieved."));
		save(new Answer(14, 14, 56 , null));
		save(new Answer(19, 19, 76 , "The other options are functional requirements. Note that security is regarded as a functional requirement in this syllabus."));
